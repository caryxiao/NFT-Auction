...
const deployDDNFT: DeployFunction = async function (
  ...
  try {
    ...
    const proxyAddress = await ddnft.getAddress();
    ...
    await save('DDNFTProxy', {
      ...
      abi: JSON.parse(DDNFT.interface.formatJson()),
...
deployDDNFT.tags = ['ddnft', 'ddnftv1'];
deployDDNFT.dependencies = [];

export default deployDDNFT;
